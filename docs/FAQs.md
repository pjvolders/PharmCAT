...
[PharmCAT requires input genomic data to be in VCF format.](https://github.com/PharmGKB/PharmCAT/wiki/VCF-Requirements) If you can transform your data into valid VCF that meets the requirements outlined in PharmCAT documentation then you can run it. However, if you're not familiar with genomic data tools then this may be an extremely difficult task.
